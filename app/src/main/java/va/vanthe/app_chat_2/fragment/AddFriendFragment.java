...
import va.vanthe.app_chat_2.adapters.AddFriendAdapter;
import va.vanthe.app_chat_2.adapters.UserChatAdapter;
import va.vanthe.app_chat_2.databinding.LayoutFragmentAddfriendBinding;
...
public class AddFriendFragment extends Fragment implements UserListener {
    ...
    private LayoutFragmentAddfriendBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = LayoutFragmentAddfriendBinding.inflate(inflater,container, false);

        binding.textviewDone.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        AddFriendAdapter addFriendAdapter = new AddFriendAdapter(users, this);
        binding.contactRCV.setAdapter(addFriendAdapter);
